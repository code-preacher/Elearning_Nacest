...
$qk=mysqli_query($con,"select * from  upcoming_event_department where department='$department' order by id desc");
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    ...
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">View Department Upcoming Coming Event</a></li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-title">
                                    <h4>VIEW DEPARTMENT UPCOMING COMING EVENT</h4>
