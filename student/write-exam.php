...
if ($qs['status']=='1') {
 ...
 $qk=mysqli_query($con,"select * from exam where department='$department' and year='$year' order by id desc");
      ...
      <div class="row page-titles">
        <div class="col-md-5 align-self-center">
          ...
          <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="javascript:void(0)">Write Exam</a></li>
                      ...
                      <tbody>
                        ...
                        while ($r=mysqli_fetch_array($qk)) {
                          ...
                          <tr>
                            ...
                            <td>
                              <?php if ($r['status'] === '1') {  ?>
                              <a href="start-exam.php?id=<?php echo $r['id']?>"><i class="fa fa-edit text-primary"></i></a>
                              <?php   } else { ?>
                                <a href="#" style="pointer-events: none;"><i class="fa fa-edit text-danger disabled"></i></a>
                              <?php  } ?>
                            </td>
                          </tr>
                          <?php                                                
