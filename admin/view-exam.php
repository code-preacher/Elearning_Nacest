...
$qk=mysqli_query($con,"select * from exam order by id desc");
                      ...
                      <tbody>
                        ...
                        while ($r=mysqli_fetch_array($qk)) {
                          ...
                          <tr>
                            ...
                            <td><a href="score-exam.php?id=<?php echo $r['id']?>"><i class="fa fa-edit text-primary"></i></a></td>
