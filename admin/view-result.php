...
$qk=mysqli_query($con,"select * from result order by id desc");
?>
<!DOCTYPE html>
<html lang="en">
                                    ...
                                    <tbody>
                                        ...
                                        while ($r=mysqli_fetch_array($qk)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $r['gp']; ?></td>
                                                <td><?php echo $r['gp_type']; ?></td>
                                                <td><?php echo $r['issue']; ?></td>
                                                
                                                <td><?php echo $r['date_created']; ?></td>
                                                <td><a href="delete-result.php?id=<?php echo $r['id']?>" onClick="return confirm('Are you sure you want to delete this result ?')"><i class="fa fa-bitbucket text-danger"></i></a></td>
