...
//$no=mysqli_insert_id($con);
  $matno="NACEST/DIST/".rand(uniqid(),123456);
...
<div class="form-actions">
  <button type="submit" name="sub" class="btn btn-success"> <i class="fa fa-plus"></i> Add</button>
  <button type="reset" class="btn btn-inverse"><i class="fa fa-refresh"></i> Clear</button>
</div>
</form>
