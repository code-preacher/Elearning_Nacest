...
?>
<?php
$qk=mysqli_query($con,"select * from application order by id desc");
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    ...
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">View Application</a></li>
                                        ...
                                        <tbody>
                                            ...
                                            while ($r=mysqli_fetch_array($qk)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php if($r['status']==='1'){echo 'Admitted';}else{echo 'Not Admitted';}?></td>
